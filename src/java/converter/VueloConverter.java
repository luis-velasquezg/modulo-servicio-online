...
@FacesConverter(value = "vueloConverter")
public class VueloConverter implements Converter {

    private VueloFacade ejbFacade;
    ...
    private VueloFacade getEjbFacade() {
        this.ejbFacade = CDI.current().select(VueloFacade.class).get();
